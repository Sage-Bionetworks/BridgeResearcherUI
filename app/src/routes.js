...
router.on("/files/:guid", redirectTo("/files/{0}/general"));
router.on("/files/:guid/general", routeTo("file", "files", GUID));
router.on("/files/:guid/revisions", routeTo("file_revisions", "files", GUID));
