...
reg('subpopulation_history','./pages/subpopulation_history/subpopulation_history');
reg('subpopulation_download','./pages/subpopulation_download/subpopulation_download');
...
reg('withdrawal', './dialogs/withdrawal/withdrawal');
