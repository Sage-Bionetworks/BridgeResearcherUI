...
import verifyEmail from "./pages/email_templates/verify_email";
import verifyEmailHtml from "./pages/email_templates/verify_email.html";
import rp from "./pages/email_templates/reset_password";
import rpHtml from "./pages/email_templates/reset_password.html";
import emailSignIn from "./pages/email_templates/email_signin";
import emailSignInHtml from "./pages/email_templates/email_signin.html";
import signedConsent from "./pages/email_templates/signed_consent";
import signedConsentHtml from "./pages/email_templates/signed_consent.html";
import accountExists from "./pages/email_templates/account_exists";
import accountExistsHtml from "./pages/email_templates/account_exists.html";
import appInstallLink from "./pages/email_templates/app_install_link";
import appInstallLinkHtml from "./pages/email_templates/app_install_link.html";
import verifyPhone from "./pages/sms_templates/verify_phone";
import verifyPhoneHtml from "./pages/sms_templates/verify_phone.html";
import rpSms from "./pages/sms_templates/reset_password";
import rpSmsHtml from "./pages/sms_templates/reset_password.html";
import phoneSignIn from "./pages/sms_templates/phone_signin";
import phoneSignInHtml from "./pages/sms_templates/phone_signin.html";
import smsSignedConsent from "./pages/sms_templates/signed_consent";
import smsSignedConsentHtml from "./pages/sms_templates/signed_consent.html";
import smsAccountExists from "./pages/sms_templates/account_exists";
import smsAccountExistsHtml from "./pages/sms_templates/account_exists.html";
import smsInstallLink from "./pages/sms_templates/app_install_link";
import smsInstallLinkHtml from "./pages/sms_templates/app_install_link.html";
...
import critHtml from "./widgets/criteria/criteria.html";
...
reg("verify_email", {viewModel: verifyEmail, template: verifyEmailHtml});
reg("reset_password", {viewModel: rp, template: rpHtml});
reg("email_signin", {viewModel: emailSignIn, template: emailSignInHtml});
reg("signed_consent", {viewModel: signedConsent, template: signedConsentHtml});
reg("account_exists", {viewModel: accountExists, template: accountExistsHtml});
reg("app_install_link", {viewModel: appInstallLink, template: appInstallLinkHtml});
reg("sms_verify_phone", {viewModel: verifyPhone, template: verifyPhoneHtml});
reg("sms_reset_password", {viewModel: rpSms, template: rpSmsHtml});
reg("sms_phone_signin", {viewModel: phoneSignIn, template: phoneSignInHtml});
reg("sms_signed_consent", {viewModel: smsSignedConsent, template: smsSignedConsentHtml});
reg("sms_account_exists", {viewModel: smsAccountExists, template: smsAccountExistsHtml});
reg("sms_app_install_link", {viewModel: smsInstallLink, template: smsInstallLinkHtml});
