...
import exportV2 from "./pages/export/export_v2";
import exportV2Html from "./pages/export/export_v2.html";
import exportV3 from "./pages/export/export_v3";
import exportV3Html from "./pages/export/export_v3.html";
import exportTabsetHtml from "./pages/export/tabset.html";
...
import studyExport from "./pages/study/export";
import studyExportHtml from "./pages/study/export.html";
import studyUi from "./pages/study/ui";
import studyUiHtml from "./pages/study/ui.html";
import studyEvents from "./pages/study/events";
import studyEventsHtml from "./pages/study/events.html";
import studySchedule from "./pages/schedule2/schedule";
import studyScheduleHtml from "./pages/schedule2/schedule.html";
...
import studyAdherence from "./pages/study/adherence";
import studyAdherenceHtml from "./pages/study/adherence.html";
import studyAdherenceStats from "./pages/study/adherence_stats";
import studyAdherenceStatsHtml from "./pages/study/adherence_stats.html";
...
import studypartEvents from "./pages/studyparticipant/events";
import studypartEventsHtml from "./pages/studyparticipant/events.html";
...
reg("exportV2", {viewModel: exportV2, template: exportV2Html});
reg("exportV3", {viewModel: exportV3, template: exportV3Html});
reg("export-tabset", {template: exportTabsetHtml});
...
reg("studyExport", {viewModel: studyExport, template: studyExportHtml});
...
reg("studySchedule", {viewModel: studySchedule, template: studyScheduleHtml});
...
reg("studyAdherence", {viewModel: studyAdherence, template: studyAdherenceHtml});
reg("studyAdherenceStats", {viewModel: studyAdherenceStats, template: studyAdherenceStatsHtml});
