...
ko.bindingHandlers.flatpickr = {
  init: function(element, valueAccessor, allBindings) {
    ...
    let instance = flatpickr(element, {
      defaultDate: observer(),
...
ko.bindingHandlers.ckeditor = {
  init: function(element, valueAccessor) {
    ...
    CKEDITOR.addCss(".bridge-sig-block{width:100%;margin-top:30px}.bridge-sig-block td{width:33%;vertical-align:bottom;padding:.5rem}.bridge-sig-block .label{display:block;border-top:2px solid}");
...
ko.bindingHandlers.modal = {
  init: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
    ...
    observable.subscribe(function(newConfig, params) {
      let closeable =
        newConfig.params && typeof newConfig.params.closeable !== "undefined" ? newConfig.params.closeable : true;
