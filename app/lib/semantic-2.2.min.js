              ...
              e.each(o, function(i, o) {
                ...
                a.moduleExists(o) &&
                  ...
                  r &&
                    l &&
                    ((s = e(":data(module-" + l + ")")),
                    s.length > 0 && (a.verbose("Modifying existing settings", s), s[o]("setting", t, n))));
              });
          },
              ...
              e.each(n, function(n, i) {
                ...
                a.moduleExists(i) &&
                  ...
                  o &&
                    m &&
                    ((r = e(":data(module-" + m + ")")),
                    r.length > 0 && (a.verbose("Modifying existing settings", r), r[i]("setting", t))));
              });
          }
        },
        enable: {
        ...
        performance: {
          log: function(e) {
            ...
            f.performance &&
              ...
              (n = t - i),
              (s = t),
              l.push({ Element: b, Name: e[0], Arguments: [].slice.call(e, 1) || "", "Execution Time": n })),
    ...
    (t =
            ...
            (F = {
              ...
              reset: function() {
                m.each(function() {
                  ...
                  r !== i &&
                    (c && (F.verbose("Resetting error on field", o), o.removeClass(S.error), a.remove()),
                    l
                      ? (F.verbose("Resetting dropdown value", n, r), n.dropdown("restore defaults"))
                      : s
                      ? (F.verbose("Resetting checkbox value", n, r), t.prop("checked", r))
                ...
                field: {
                  ...
                  blur: function(t) {
                    ...
                    i.hasClass(S.error)
                      ...
                      : ("blur" == x.on || "change" == x.on) && o && F.validate.field(o);
                  },
                  change: function(t) {
                    var n = e(this),
                      i = n.closest(g),
                  ...
                  if (e.isPlainObject(t)) {
                    ...
                    a
                      ? ((x = e.extend(!0, {}, e.fn.form.settings, u)),
                        ...
                        F.verbose("Extending settings from legacy parameters", C, x))
                      : (t.fields &&
                ...
                field: function(e) {
                  return (
                    ...
                    m.filter("#" + e).length > 0
                      ...
                      ? !0
                      : m.filter("[data-" + w.validate + '="' + e + '"]').length > 0
                      ? !0
                      : !1
                  );
                }
                  ...
                  (n = "string" == typeof n ? [n] : n),
                    ...
                    x.inline &&
                      ...
                      s
                        ...
                        : x.transition && e.fn.transition !== i && O.transition("is supported")
                        ? (F.verbose("Displaying error with css transition", x.transition),
                          r.transition(x.transition + " in", x.duration))
                        : (F.verbose("Displaying error with fallback javascript animation"), r.fadeIn(x.duration)));
                },
                errors: function(e) {
                      ...
                      u &&
                        (r && s
                          ...
                          ? (F.verbose("Setting checkbox value", n, a),
                            n === !0 ? a.checkbox("check") : a.checkbox("uncheck"))
                          : l
              ...
              validate: {
                form: function(e, t) {
                  ...
                  if (j) return !1;
                  if (((q = []), F.is.valid())) {
                    if ((F.debug("Form has no validation errors, submitting"), F.set.success(), t !== !0))
                ...
                field: function(t, n) {
                  ...
                  return (
                    ...
                    s
                      ...
                      : ((q = q.concat(l)), F.add.prompt(o, l), x.onInvalid.call(a, l), !1)
                  );
                },
                rule: function(t, n) {
                  ...
                  return e.isFunction(l)
                    ? ((a = a === i || "" === a || null === a ? "" : e.trim(a + "")), l.call(o, a, r))
              ...
              debug: function() {
                !x.silent &&
                  ...
                  (x.performance
                    ...
                    : ((F.debug = Function.prototype.bind.call(console.info, console, x.name + ":")),
              ...
              verbose: function() {
                !x.silent &&
                  ...
                  (x.performance
                    ? F.performance.log(arguments)
                    : ((F.verbose = Function.prototype.bind.call(console.info, console, x.name + ":")),
              ...
              performance: {
                log: function(e) {
                  ...
                  x.performance &&
                    ...
                    (n = t - i),
                    (s = t),
                    l.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: D, "Execution Time": n })),
      ...
      (e.fn.form.settings = {
        ...
        rules: {
          ...
          is: function(e, t) {
            return (
              (t = "string" == typeof t ? t.toLowerCase() : t), (e = "string" == typeof e ? e.toLowerCase() : e), e == t
            );
          },
            ...
            (m = {
              ...
              event: {
                click: function(t) {
                  var n = e(t.target);
                  return n.is(v.input)
                    ? void m.verbose("Using default check action on initialized checkbox")
                    : n.is(v.link)
                    ? void m.debug("Clicking link inside checkbox, skipping toggle")
                ...
                keydown: function(e) {
                  ...
                  t == n.escape
                    ? (m.verbose("Escape key pressed blurring field"), k.blur(), (A = !0))
              ...
              check: function() {
                m.should.allowCheck() &&
                  ...
                  m.set.checked(),
                  m.should.ignoreCallbacks() || (g.onChecked.call(S), g.onChange.call(S)));
              },
              uncheck: function() {
                m.should.allowUncheck() &&
                  (m.debug("Unchecking checkbox"),
                  m.set.unchecked(),
                  m.should.ignoreCallbacks() || (g.onUnchecked.call(S), g.onChange.call(S)));
              },
              indeterminate: function() {
                return m.should.allowIndeterminate()
                  ...
                  : (m.debug("Making checkbox indeterminate"),
                    m.set.indeterminate(),
                    void (m.should.ignoreCallbacks() || (g.onIndeterminate.call(S), g.onChange.call(S))));
              },
              determinate: function() {
                return m.should.allowDeterminate()
                  ...
                  : (m.debug("Making checkbox determinate"),
                    m.set.determinate(),
                    void (m.should.ignoreCallbacks() || (g.onDeterminate.call(S), g.onChange.call(S))));
              },
              enable: function() {
                return m.is.enabled()
                  ? void m.debug("Checkbox is already enabled")
                  : (m.debug("Enabling checkbox"), m.set.enabled(), g.onEnable.call(S), void g.onEnabled.call(S));
              },
              disable: function() {
                return m.is.disabled()
                  ? void m.debug("Checkbox is already disabled")
                  : (m.debug("Disabling checkbox"), m.set.disabled(), g.onDisable.call(S), void g.onDisabled.call(S));
              },
              get: {
                radios: function() {
                  var t = m.get.name();
              ...
              set: {
                ...
                checked: function() {
                  return (
                    ...
                    !m.is.indeterminate() && m.is.checked()
                      ? void m.debug("Input is already checked, skipping input property change")
                ...
                indeterminate: function() {
                  return (
                    ...
                    m.is.indeterminate()
                      ? void m.debug("Input is already indeterminate, skipping input property change")
                ...
                determinate: function() {
                  return (
                    ...
                    m.is.determinate()
                      ? void m.debug("Input is already determinate, skipping input property change")
                      : (m.debug("Setting state to determinate"), void k.prop("indeterminate", !1))
                  );
                },
                disabled: function() {
                  return (
                    ...
                    m.is.disabled()
                      ? void m.debug("Input is already disabled, skipping input property change")
                      : (m.debug("Setting state to disabled"), k.prop("disabled", "disabled"), void m.trigger.change())
                  );
                },
                enabled: function() {
                  return (
                    ...
                    m.is.enabled()
                      ? void m.debug("Input is already enabled, skipping input property change")
                      : (m.debug("Setting state to enabled"), k.prop("disabled", !1), void m.trigger.change())
                  );
                },
                tabbable: function() {
              ...
              create: {
                label: function() {
                  k.prevAll(v.label).length > 0
                    ...
                    : m.has.label() || ((w = e("<label>").insertAfter(k)), m.debug("Creating label", w));
                }
              },
              has: {
                label: function() {
              ...
              toggle: function() {
                return m.can.change()
                  ...
                  : void (m.is.radio() || m.debug("Checkbox is read-only or disabled, ignoring toggle"));
              },
              setting: function(t, n) {
              ...
              hide: function(t) {
                (t = e.isFunction(t) ? t : function() {}),
                  m.is.dimmed() || m.is.animating()
                    ? (m.debug("Hiding dimmer", d), m.animate.hide(t), g.onHide.call(S), g.onChange.call(S))
            ...
            (k = {
                  ...
                  return (t = t || k.get.userValues())
                    ? ((t = e.isArray(t) ? t : [t]),
                      e.each(t, function(t, r) {
                        k.get.item(r) === !1 &&
                          ((a = S.templates.addition(k.add.variables(A.addResult, r))),
                          (o = e("<div />")
                            .html(a)
                            .attr("data-" + E.value, r)
                            .attr("data-" + E.text, r)
              ...
              select: {
                ...
                nextAvailable: function(e) {
                  ...
                  var t = e
                    ...
                    i = t.length > 0;
                  i
                    ? (k.verbose("Moving selection to", t), t.addClass(T.selected))
                    : (k.verbose("Moving selection to", n), n.addClass(T.selected));
                }
              },
              setup: {
                api: function() {
                ...
                select: function() {
                  ...
                  k.debug("Dropdown initialized on a select", t),
                    ...
                    U.parent(D.dropdown).length > 0
                      ? (k.debug("UI dropdown already exists. Creating dropdown menu only"),
                      ...
                      : (k.debug("Creating entire dropdown from select"),
                        ...
                        U.prop("disabled") && (k.debug("Disabling dropdown"), I.addClass(T.disabled)),
                        U.removeAttr("class")
                          .detach()
                          .prependTo(I)),
                    k.refresh();
              ...
              bind: {
                ...
                mouseEvents: function() {
                  k.verbose("Binding mouse events"),
                    k.is.multiple() &&
                      I.on("click" + z, D.label, k.event.label.click).on("click" + z, D.remove, k.event.remove.click),
                    k.is.searchSelection()
                      ...
                      : ("click" == S.on
                          ? I.on("click" + z, D.icon, k.event.icon.click).on("click" + z, k.event.test.toggle)
                          : "hover" == S.on
                          ? I.on("mouseenter" + z, k.delay.show).on("mouseleave" + z, k.delay.hide)
                    ...
                    k.is.multiple() && k.filterActive(),
                      ...
                      k.has.allResultsFiltered()
                        ? S.onNoResults.call(Z, t)
                          ? S.allowAdditions
                            ? S.hideAdditions &&
                              (k.verbose("User addition with no menu, setting empty style"),
                              k.set.empty(),
                              k.hideMenu())
                            : (k.verbose("All items filtered, showing message", t), k.add.message(A.noResults))
                          : (k.verbose("All items filtered, hiding dropdown", t), k.hideMenu())
              ...
              focusSearch: function(e) {
                k.has.search() &&
                  ...
                  (e
                    ? (I.off("focus" + z, D.search), V.focus(), I.on("focus" + z, D.search, k.event.search.focus))
                    : V.focus());
              },
              forceSelection: function() {
                var e = X.not(T.filtered)
                  ...
                  i = n.length > 0;
                return i
                  ? (k.debug("Forcing partial selection to selected item", n), void k.event.item.click.call(n, {}, !0))
              ...
              event: {
                ...
                search: {
                  ...
                  blur: function(e) {
                    (v = n.activeElement === this),
                      b || Y || v || (S.forceSelection && k.has.query() && k.forceSelection(), k.hide()),
                      (b = !1);
                  }
                },
                icon: {
                ...
                menu: {
                  mutation: function(t) {
                    ...
                    r || s
                      ? (k.debug("Updating item selector cache"), k.refreshItems())
                      : (k.debug("Menu modified, updating selector cache"), k.refresh());
                  },
                  mousedown: function() {
                    Y = !0;
                  },
                ...
                item: {
                  ...
                  click: function(t, n) {
                    ...
                    c ||
                      ...
                      S.useLabels || (k.remove.filteredItem(), k.set.scrollPosition(i)),
                      ...
                      t == P.leftArrow
                        ? (!m && !g) || s
                          ? s &&
                            (e.shiftKey
                              ...
                              : (k.verbose("Selecting previous label"), i.removeClass(T.active)),
                            c && !l
                              ? o.addClass(T.active)
                              : o
                                  .prev(D.siblingLabel)
                                  ...
                                  .end(),
                            e.preventDefault())
                          : (k.verbose("Selecting previous label"), i.last().addClass(T.active))
                        : t == P.rightArrow
                        ? (m && !s && i.first().addClass(T.active),
                          s &&
                            (e.shiftKey
                              ? k.verbose("Adding next label to selection")
                              : (k.verbose("Selecting next label"), i.removeClass(T.active)),
                            u
                              ? d
                                ? f
                        ...
                        ? s
                          ...
                          : g &&
                            !s &&
                            t == P.backspace &&
                            (k.verbose("Removing last label on input backspace"),
                ...
                keydown: function(e) {
                  ...
                  if (n) {
                    ...
                    if (
                      ...
                      if (
                        ((t == P.enter || p) &&
                          (t == P.enter && m && f && !S.allowCategorySelection
                            ? (k.verbose("Pressed enter on unselectable category, opening sub menu"),
                              (t = P.rightArrow))
                            : g &&
                              (k.verbose("Selecting item from keyboard shortcut", s),
                              k.event.item.click.call(s, e),
                        ...
                        if (
                          ((i = m && d ? s.prevAll(D.item + ":not(" + D.unselectable + ")").eq(0) : X.eq(0)),
                          l.index(i) < 0)
                        )
                      ...
                      if (t == P.downArrow) {
                        if (
                          ((i = m && d ? (i = s.nextAll(D.item + ":not(" + D.unselectable + ")").eq(0)) : X.eq(0)),
                          0 === i.length)
                        )
                          return (
                            k.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault()
                          );
                        k.verbose("Down key pressed, changing active item"),
                          ...
                          S.selectOnKeydown &&
                            k.is.single() &&
                            (k.set.activeItem(i), k.set.selected(k.get.choiceValue(i), i)),
                          e.preventDefault();
                      }
                      t == P.pageUp && (k.scrollPage("up"), e.preventDefault()),
                        t == P.pageDown && (k.scrollPage("down"), e.preventDefault()),
                        t == P.escape && (k.verbose("Escape key pressed, closing dropdown"), k.hide());
                    } else
                      p && e.preventDefault(),
                        t != P.downArrow ||
                          k.is.visible() ||
              ...
              determine: {
                selectAction: function(t, n) {
                  k.verbose("Determining action", S.action),
                    e.isFunction(k.action[S.action])
                      ? (k.verbose("Triggering preset action", S.action, t, n), k.action[S.action].call(Z, t, n, this))
                      : e.isFunction(S.action)
                      ? (k.verbose("Triggering user action", S.action, t, n), S.action.call(Z, t, n, this))
                ...
                eventInModule: function(t, i) {
                  ...
                  return (
                    ...
                    a && !r
                      ...
                      : (k.verbose("Event occurred in dropdown, canceling callback"), !1)
                  );
                },
                eventOnElement: function(t, i) {
                  ...
                  return (
                    ...
                    r && s && l
                      ? (k.verbose("Triggering event", i), i(), !0)
                      : (k.verbose("Event occurred in dropdown menu, canceling callback"), !1)
                  );
                }
              },
              action: {
              ...
              get: {
                ...
                selectValues: function() {
                  ...
                  return (
                    ...
                    S.placeholder &&
                      "auto" !== S.placeholder &&
                      (k.debug("Setting placeholder value to", S.placeholder), (t.placeholder = S.placeholder)),
                    S.sortSelect
                ...
                item: function(t, n) {
                  var o,
                    ...
                    r = !1;
                  return (
                    (t = t !== i ? t : k.get.values() !== i ? k.get.values() : k.get.text()),
                      ...
                      X.each(function() {
                        ...
                        if (null !== l && l !== i)
                          if (a) (-1 !== e.inArray(String(l), t) || -1 !== e.inArray(s, t)) && (r = r ? r.add(o) : o);
                            ...
                            if (
                              (k.verbose("Ambiguous dropdown value using strict type check", o, t), l === t || s === t)
                            )
                              return (r = o), !0;
                          } else if (String(l) == String(t) || s == t)
                            return k.verbose("Found select item by value", l, t), (r = o), !0;
                      }),
                    r
                  );
                }
                    ...
                    ? ((e = e !== i ? e : k.get.selectionCount()),
                      e >= S.maxSelections
                        ? (k.debug("Maximum selection count reached"),
                          S.useLabels && (X.addClass(T.filtered), k.add.message(A.maxSelections)),
                          !0)
              ...
              restore: {
                ...
                defaultText: function() {
                  ...
                  e === t
                    ? (k.debug("Restoring default placeholder text", e), k.set.placeholderText(e))
                ...
                defaultValue: function() {
                  ...
                  e !== i &&
                    ...
                    "" !== e ? (k.set.value(e), k.set.selected()) : (k.remove.activeItem(), k.remove.selectedItem()));
                },
                labels: function() {
                  S.allowAdditions &&
                ...
                selected: function() {
                  k.restore.values(),
                    k.is.multiple()
                      ? (k.debug("Restoring previously selected values and labels"), k.restore.labels())
              ...
              save: {
                ...
                placeholderText: function() {
                  ...
                  S.placeholder !== !1 &&
                    ...
                    ((e = k.get.text()), k.verbose("Saving placeholder text as", e), I.data(E.placeholderText, e));
                },
                remoteData: function(e, n) {
                  return t.Storage === i
                    ? void k.error(q.noStorage)
                    : (k.verbose("Saving remote data to session storage", n, e), void sessionStorage.setItem(n, e));
                }
              },
              clear: function() {
                k.is.multiple() ? k.remove.labels() : (k.remove.activeItem(), k.remove.selectedItem()),
                  k.set.placeholderText(),
                  k.clearValue();
              },
              clearValue: function() {
              ...
              set: {
                filtered: function() {
                  ...
                  e && o && (k.verbose("Adjusting input width", a, S.glyphWidth), V.css("width", a)),
                    o || (n && r)
                      ? (k.verbose("Hiding placeholder text"), N.addClass(T.filtered))
                      : (!e || (n && !r)) && (k.verbose("Showing placeholder text"), N.removeClass(T.filtered));
                },
                empty: function() {
                  I.addClass(T.empty);
                },
                ...
                tabbable: function() {
                  k.has.search()
                    ...
                    : (k.debug("Added tabindex to dropdown"),
                      I.attr("tabindex") === i && (I.attr("tabindex", 0), Q.attr("tabindex", -1)));
                },
                initialLoad: function() {
                ...
                scrollPosition: function(e, t) {
                  ...
                  (e = e || k.get.selectedItem()),
                    ...
                    e &&
                      ...
                      (r = e.offset().top),
                      (a = l - s + r),
                      t || ((c = n.height()), (d = a + f > l + c), (u = l > a - f)),
                ...
                text: function(e) {
                  "select" !== S.action &&
                    ("combo" == S.action
                      ? (k.debug("Changing combo button text", e, B), S.preserveHTML ? B.html(e) : B.text(e))
                      : (e !== k.get.placeholderText() && N.removeClass(T.placeholder),
                ...
                value: function(e, t, n) {
                  ...
                  if (a) {
                    if (
                      !S.allowReselection &&
                      s == r &&
                      (k.verbose("Skipping value update already same value", e, r), !k.is.initialLoad())
                    )
                      return;
                    k.is.single() &&
                      k.has.selectInput() &&
                      ...
                      S.fireOnInit === !1 && k.is.initialLoad()
                        ? k.debug("Input native change event ignored on initial load")
                        : k.trigger.change(),
                      (K = !1);
                  ...
                  (n = S.allowAdditions ? n || k.get.itemWithAdditions(t) : n || k.get.item(t)),
                    n &&
                      ...
                      n.each(function() {
                        ...
                        i
                          ? !s || l
                            ? (S.apiSettings && S.saveRemoteData && k.save.remoteData(o, a),
                              S.useLabels
                                ? (k.add.value(a, o, t),
                                  k.add.label(a, o, c),
                                  k.set.activeItem(t),
                                ...
                                : (k.add.value(a, o, t), k.set.text(k.add.variables(A.count)), k.set.activeItem(t)))
                            : r || (k.debug("Selected active value, removing label"), k.remove.selected(a))
                          : (S.apiSettings && S.saveRemoteData && k.save.remoteData(o, a),
                            k.set.text(o),
                            k.set.value(a, o, t),
              ...
              add: {
                    ...
                    k.has.label(t)
                      ...
                      : (S.label.variation && o.addClass(S.label.variation),
                        void (i === !0
                          ...
                          : (k.debug("Adding selection label", o), o.insertBefore(a))))
                  );
                },
                message: function(t) {
                ...
                optionValue: function(t) {
                  ...
                  o ||
                    (k.disconnect.selectObserver(),
                    k.is.single() &&
                      (k.verbose("Removing previous user addition"), U.find("option." + T.addition).remove()),
                    e("<option/>")
                      .prop("value", n)
                      .addClass(T.addition)
                      .html(t)
                  ...
                  if (!S.useLabels || !k.has.maxSelections()) {
                    ...
                    a
                      ? (n
                        ...
                        S.hideAdditions || ((t = S.templates.addition(k.add.variables(A.addResult, e))), n.html(t)),
                        k.verbose("Replacing user suggestion with new value", n))
                      : ((n = k.create.userChoice(e)),
                        n.prependTo(Q),
                ...
                value: function(t, n, i) {
                  var o,
                    a = k.get.values();
                  return "" === t
                    ? void k.debug("Cannot select blank values from multiselect")
                    : (e.isArray(a) ? ((o = a.concat([t])), (o = k.get.uniqueArray(o))) : (o = [t]),
                      k.has.selectInput()
                        ? k.can.extendSelect() && (k.debug("Adding value to select", t, o, U), k.add.optionValue(t))
                        : ((o = o.join(S.delimiter)), k.debug("Setting hidden input to delimited value", o, U)),
                      S.fireOnInit === !1 && k.is.initialLoad()
                        ? k.verbose("Skipping onadd callback on initial load", S.onAdd)
              ...
              remove: {
                ...
                optionValue: function(e) {
                  ...
                  i &&
                    ...
                    (C && (C.disconnect(), k.verbose("Temporarily disconnecting mutation observer")),
                    n.remove(),
                ...
                selected: function(t, n) {
                  return (n = S.allowAdditions ? n || k.get.itemWithAdditions(t) : n || k.get.item(t))
                ...
                value: function(e, t, n) {
                  var i,
                    o = k.get.values();
                  k.has.selectInput()
                    ? (k.verbose("Input is <select> removing selected option", e),
                  ...
                  (t = t || I.find(D.label)),
                    ...
                    t.each(function() {
                      ...
                      return S.onLabelRemove.call(t, n) === !1
                        ? void k.debug("Label remove callback cancelled removal")
                        : (k.remove.message(),
                          void (a ? (k.remove.value(o), k.remove.label(o)) : k.remove.selected(o)));
                    });
                },
                tabbable: function() {
                  k.has.search()
                    ? (k.debug("Searchable dropdown initialized"), V.removeAttr("tabindex"), Q.removeAttr("tabindex"))
              ...
              is: {
                ...
                onScreen: function(e) {
                  ...
                  return (
                    ...
                    o.below
                      ? (k.verbose("Dropdown can fit in context downward", o), (i = !0))
                      : o.below || o.above
                      ? (k.verbose("Dropdown cannot fit below, opening upward", o), (i = !1))
                      : (k.verbose("Dropdown cannot fit in either direction, favoring downward", o), (i = !0)),
                    n.removeClass(T.loading),
                    i
                  );
                },
              ...
              performance: {
                log: function(e) {
                  ...
                  S.performance &&
                    ...
                    (n = t - i),
                    (u = t),
                    d.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: Z, "Execution Time": n })),
                  ...
                  "string" == typeof t &&
                    ...
                    e.each(t, function(n, o) {
                      ...
                      if (e.isPlainObject(c[a]) && n != r) c = c[a];
                        ...
                        if (c[a] !== i) return (s = c[a]), !1;
                        if (!e.isPlainObject(c[o]) || n == r)
                          return c[o] !== i ? ((s = c[o]), !1) : (k.error(q.method, t), !1);
                        c = c[o];
                      }
                    })),
                  e.isFunction(s) ? (l = s.apply(o, n)) : s !== i && (l = s),
            ...
            (f = {
              ...
              generate: {
                ...
                parameters: function(t, n) {
                  ...
                  return (
                    (n = n || m.parameters), n && (o = e.extend({}, o, n)), (o = m.onEmbed(o)), f.encode.parameters(o)
                  );
                }
              },
              has: {
            ...
            (S = {
              ...
              create: {
                dimmer: function() {
                  ...
                  return (
                    T.inverted && (n.variation = n.variation !== i ? n.variation + " inverted" : "inverted"),
                    e.fn.dimmer === i
                      ? void S.error(E.dimmer)
                      : (S.debug("Creating dimmer with settings", n),
                        (y = q.dimmer(n)),
                        T.detachable
                          ? (S.verbose("Modal is detachable, moving content into dimmer"), y.dimmer("add content", D))
                          : S.set.undetached(),
              ...
              attachEvents: function(t, n) {
                ...
                (n = e.isFunction(S[n]) ? S[n] : S.toggle),
                  i.length > 0
                    ? (S.debug("Attaching modal events to element", t, n), i.off(F).on("click" + F, n))
              ...
              event: {
                approve: function() {
                  return T.onApprove.call(z, e(this)) === !1
                    ? void S.verbose("Approve callback returned false cancelling hide")
                    : void S.hide();
                },
                deny: function() {
                  return T.onDeny.call(z, e(this)) === !1
                    ? void S.verbose("Deny callback returned false cancelling hide")
                    : void S.hide();
                },
                close: function() {
                  S.hide();
                ...
                click: function(t) {
                  ...
                  !o &&
                    ...
                    S.is.active() && (S.remove.clickaway(), T.allowMultiple ? S.hide() : S.hideAll()));
                },
              ...
              hideModal: function(t, n) {
                return (
                  ...
                  T.onHide.call(z, e(this)) === !1
                    ? void S.verbose("Hide callback returned false cancelling hide")
                    : void (
                        (S.is.animating() || S.is.active()) &&
                        (T.transition && e.fn.transition !== i && D.transition("is supported")
                          ? (S.remove.active(),
                ...
                type: function() {
                  S.can.fit()
                    ? (S.verbose("Modal fits on screen"),
                      S.others.active() || S.others.animating() || S.remove.scrolling())
              ...
              debug: function() {
                !T.silent &&
                  ...
                  (T.performance
                    ...
                    : ((S.debug = Function.prototype.bind.call(console.info, console, T.name + ":")),
              ...
              verbose: function() {
                !T.silent &&
                  ...
                  (T.performance
                    ? S.performance.log(arguments)
                    : ((S.verbose = Function.prototype.bind.call(console.info, console, T.name + ":")),
          ...
          r.each(function() {
            ...
            (C = {
                  ...
                  w.popup
                    ? (r.addClass(S.loading),
                      ...
                      w.movePopup &&
                        ...
                        (C.debug("Moving popup to the same offset parent as activating element"),
                        r.detach().appendTo(v)))
                    : (v = w.inline ? C.get.offsetParent(j) : C.has.popup() ? C.get.offsetParent(r) : c),
                ...
                t || i || n
                  ? (C.debug("Creating pop-up html"),
                    ...
                    (r = e("<div/>")
                      ...
                      .html(t)),
                    w.inline
                      ? (C.verbose("Inserting popup element inline", r), r.insertAfter(F))
                      : (C.verbose("Appending popup element to body", r), r.appendTo(O)),
                    C.refresh(),
                    C.set.variation(),
              ...
              restore: {
                conditions: function() {
                  return (
                    C.cache &&
                      C.cache.title &&
                      (F.attr("title", C.cache.title), C.verbose("Restoring original attributes", C.cache.title)),
                    !0
                  );
                }
              },
              ...
              animate: {
                show: function(t) {
                  (t = e.isFunction(t) ? t : function() {}),
                    w.transition && e.fn.transition !== i && F.transition("is supported")
                      ? (C.set.visible(),
                        r.transition({
                ...
                hide: function(t) {
                  return (
                    ...
                    w.onHide.call(r, L) === !1
                      ...
                      : void (w.transition && e.fn.transition !== i && F.transition("is supported")
                          ? r.transition({
              ...
              get: {
                ...
                calculations: function() {
                  ...
                  return (
                    ...
                    w.setFluidWidth &&
                      C.is.fluid() &&
                      ((s.container = { width: r.parent().outerWidth() }), (s.popup.width = s.container.width)),
                ...
                offsetParent: function(t) {
                  ...
                  if (o)
                    for (
                      var r = "none" === a.css("transform"), s = "static" === a.css("position"), l = a.is("html");
                      o && !l && s && r;
                ...
                nextPosition: function(e) {
                  var t = e.split(" "),
                    ...
                    u = !1;
                  return (
                    M || (C.verbose("All available positions available"), (M = C.get.positions())),
                    C.debug("Recording last position tried", e),
                    (M[e] = !0),
                    "opposite" === w.prefer &&
                      ((u = [o[n], i]), (u = u.join(" ")), (l = M[u] === !0), C.debug("Trying opposite strategy", u)),
                    "adjacent" === w.prefer &&
                      s &&
                      ((u = [n, a[i]]), (u = u.join(" ")), (c = M[u] === !0), C.debug("Trying adjacent strategy", u)),
              ...
              set: {
                position: function(e, t) {
                  ...
                  if (
                    ...
                    if ((C.debug("Position is outside viewport", e), z < w.maxSearchDepth))
                      return (
                        z++,
                    ...
                    if (!w.lastResort)
                      return (
                        C.debug("Popup could not find a position to display", r),
              ...
              bind: {
                events: function() {
                  C.debug("Binding popup events to module"),
                    ...
                    C.get.startEvent() &&
                      F.on(C.get.startEvent() + P, C.event.start).on(C.get.endEvent() + P, C.event.end),
                ...
                close: function() {
                  (w.hideOnScroll === !0 || ("auto" == w.hideOnScroll && "click" != w.on)) &&
              ...
              performance: {
                log: function(e) {
                  ...
                  w.performance &&
                    ...
                    (n = t - i),
                    (f = t),
                    m.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: L, "Execution Time": n })),
          ...
          (f = {
            ...
            read: {
              ...
              settings: function() {
                m.total !== !1 && (f.debug("Current total set in settings", m.total), f.set.total(m.total)),
                  m.value !== !1 &&
                    (f.debug("Current value set in settings", m.value), f.set.value(m.value), f.set.progress(f.value)),
            ...
            decrement: function(e) {
              var t,
                ...
                i = f.get.total();
              i
                ? ((t = f.get.value()), (e = e || 1), (n = t - e), f.debug("Decrementing value by", e, t))
                : ((t = f.get.percent()),
                  (e = e || f.get.randomValue()),
                  (n = t - e),
            ...
            set: {
              barWidth: function(e) {
                e > 100
                  ...
                  : 0 > e
                  ? f.error(b.tooLow, e)
                  : (w.css("width", e + "%"), C.attr("data-percent", parseInt(e, 10)));
              },
              duration: function(e) {
                (e = e || m.duration),
              ...
              percent: function(e) {
                (e = "string" == typeof e ? +e.replace("%", "") : e),
                  ...
                  f.has.total() ||
                    ((f.value =
                      m.precision > 0
                        ? Math.round((e / 100) * f.total * (10 * m.precision)) / (10 * m.precision)
              ...
              state: function(e) {
                (e = e !== i ? e : f.percent),
                  100 === e
                    ? m.autoSuccess && !(f.is.warning() || f.is.error() || f.is.success())
              ...
              barLabel: function(e) {
                e !== i
                  ...
                  ? (f.verbose("Adding ratio to bar label"), k.text(f.get.text(m.text.ratio)))
                  : "percent" == m.label &&
                    (f.verbose("Adding percentage to bar label"), k.text(f.get.text(m.text.percent)));
              },
              active: function(e) {
                (e = e || m.text.active),
              ...
              success: function(e) {
                (e = e || m.text.success || m.text.active),
                  ...
                  f.complete(),
                  m.text.success
                    ? ((e = m.onLabelUpdate("success", e, f.value, f.total)), f.set.label(e))
                    : ((e = m.onLabelUpdate("active", e, f.value, f.total)), f.set.label(e)),
                  w.one(a + y, function() {
                ...
                (e = f.get.numericValue(e)),
                  ...
                  f.has.total()
                    ? (f.set.value(e),
                      ...
                      f.set.percent(t))
                    : ((t = e), f.debug("Setting value to exact percentage value", t), f.set.percent(t));
              }
            },
            setting: function(t, n) {
              if ((f.debug("Changing setting", t, n), e.isPlainObject(t))) e.extend(!0, m, t);
          ...
          e(this).each(function() {
            ...
            (m = {
              ...
              bind: {
                events: function() {
                  m.verbose("Binding events to search"),
                    g.automatic &&
                      (S.on(m.get.inputEvent() + w, y.prompt, m.event.input), T.attr("autocomplete", "off")),
              ...
              event: {
                      ...
                      ? (m.debug("Determining if user action caused search to close"),
                        S.one("click.close" + w, y.results, function(e) {
                          return m.is.inMessage(e) || D
                            ? void T.focus()
                            : ((D = !1), void (m.is.animating() || m.is.hidden() || i()));
                        }))
                ...
                result: {
                  ...
                  click: function(n) {
                    ...
                    return e.isFunction(g.onSelect) && g.onSelect.call(F, u, c) === !1
                      ? (m.debug("Custom onSelect callback cancelled default select action"), void (D = !0))
                      : (m.hideResults(),
                        l && m.set.value(l),
                        void (
                          r &&
              ...
              handleKeyboard: function(e) {
                ...
                if (
                  (r == s.escape && (m.verbose("Escape key pressed, blurring search field"), m.trigger.blur()),
                  m.is.visible())
                )
                  if (r == s.enter) {
                    ...
                    n === i || n === !1
                      ...
                      : (e.each(o, function(i, o) {
                          e.each(n, function(e, n) {
                            ...
                            i &&
                              (-1 !== n[o].search(l) ? c(a, n) : g.searchFullText && m.fuzzySearch(t, n[o]) && c(r, n));
                          });
                        }),
                        e.merge(a, r))
                  );
              ...
              clear: {
                cache: function(e) {
                  ...
                  e
                    ? e && t && t[e] && (m.debug("Removing value from cache", e), delete t[e], S.data(h.cache, t))
              ...
              create: {
                id: function(e, t) {
                  ...
                  return (
                    t !== i
                      ? ((n = String.fromCharCode(97 + t)), (o = n + a), m.verbose("Creating category result id", o))
              ...
              addResults: function(t) {
                return e.isFunction(g.onResultsAdd) && g.onResultsAdd.call(R, t) === !1
                  ? (m.debug("onResultsAdd callback cancelled default action"), !1)
                  : void (t
              ...
              set: {
                ...
                stageSize: function() {
                  ...
                  t.removeClass(x.active),
                    ...
                    e.remove(),
                    "auto" != h.width &&
                      (k.css("width", i + h.jitter), g.verbose("Specifying width during animation", i)),
                    "auto" != h.height &&
                      (k.css("height", o + h.jitter), g.verbose("Specifying height during animation", o));
                },
                nextSide: function(e) {
                  (A = e),
                    (m = T.filter(e)),
              ...
              stage: {
                ...
                behind: function() {
                  ...
                  g.verbose("Setting the initial animation position as behind", m, n),
                    ...
                    m.addClass(x.animating).css({ left: n.origin + "px", transform: "rotateY(-180deg)" });
                }
              },
              setting: function(t, n) {
            ...
            (w = {
                ...
                layout: function() {
                  0 === D.children(S.pusher).length &&
                    ...
                    D.children()
                      ...
                      .wrapAll(z),
                    w.refresh()),
                    (0 === O.nextAll(S.pusher).length || O.nextAll(S.pusher)[0] !== z[0]) &&
              ...
              show: function(t) {
                if (((t = e.isFunction(t) ? t : function() {}), w.is.hidden())) {
                  if (
                    (w.refreshSidebars(),
                    k.overlay && (w.error(P.overlay), (k.transition = "overlay")),
                    w.refresh(),
                    w.othersActive())
                  )
              ...
              performance: {
                log: function(e) {
                  ...
                  k.performance &&
                    ...
                    (n = t - i),
                    (f = t),
                    m.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: M, "Execution Time": n })),
            ...
            (h = {
              ...
              checkErrors: function() {
                return (
                  ...
                  h.cache.element.height > h.cache.context.height ? (h.reset(), void h.error(x.elementSize, k)) : void 0
                );
              },
              bind: {
                events: function() {
                  ...
                  (h.is.initialPosition()
                    ...
                    ? h.is.top()
                      ? e.top <= o.top
                        ...
                        : c && (h.set.scroll(l), h.save.lastScroll(e.top), h.save.elementScroll(l))
                      : h.is.bottom() &&
              ...
              determineTabs: function() {
                ...
                "parent" === x.context
                  ? (R.closest(k.ui).length > 0
                      ? ((t = R.closest(k.ui)), b.verbose("Using closest UI element as parent", t))
                      : (t = R),
                    (g = t.parent()),
                  ...
                  : (g = e("body")),
                  x.childrenOnly
                    ? ((p = g.children(k.tabs)), b.debug("Searching tab context children for tabs", g, p))
                    : ((p = g.find(k.tabs)), b.debug("Searching tab context for tabs", g, p));
              },
              fix: {
                callbacks: function() {
                  e.isPlainObject(o) &&
                    (o.onTabLoad || o.onTabInit) &&
                    (o.onTabLoad && ((o.onLoad = o.onTabLoad), delete o.onTabLoad, b.error(S.legacyLoad, o.onLoad)),
                    o.onTabInit &&
                      ((o.onFirstLoad = o.onTabInit), delete o.onTabInit, b.error(S.legacyInit, o.onFirstLoad)),
              ...
              update: {
                content: function(e, t, n) {
                  ...
                  (n = n !== i ? n : x.evaluateScripts),
                    n
                      ? (b.debug("Updating HTML and evaluating inline scripts", e, t), o.html(t))
                  ...
                  "string" == typeof t &&
                    ...
                    e.each(t, function(n, o) {
                      ...
                      if (e.isPlainObject(c[a]) && n != r) c = c[a];
                        ...
                        if (c[a] !== i) return (s = c[a]), !1;
                        if (!e.isPlainObject(c[o]) || n == r)
                          return c[o] !== i ? ((s = c[o]), !1) : (b.error(S.method, t), !1);
                        c = c[o];
                      }
                    })),
                  e.isFunction(s) ? (l = s.apply(o, n)) : s !== i && (l = s),
            ...
            (C = {
              ...
              animate: function(e) {
                ...
                if ((C.debug("Preparing animation", m.animation), C.is.animating())) {
                  if (m.queue)
                    return (
                      !m.allowRepeats && C.has.direction() && C.is.occurring() && C.queuing !== !0
                ...
                C.debug("Animation complete", m.animation),
                  ...
                  C.is.looping() ||
                    (C.is.outward()
                      ...
                      : (C.verbose("Static animation completed"), C.restore.conditions(), m.onComplete.call(k)));
              },
              force: {
                visible: function() {
                  var e = w.attr("style"),
              ...
              set: {
                ...
                duration: function(e, t) {
                  (t = t || m.duration),
                    ...
                    (t || 0 === t) && (C.verbose("Setting animation duration", t), w.css({ "animation-duration": t }));
                },
                direction: function(e) {
              ...
              get: {
                ...
                displayType: function() {
                  return m.displayType
                    ? m.displayType
                    : (w.data(v.displayType) === i && C.can.transition(!0), w.data(v.displayType));
                },
          ...
          (h = {
            ...
            bind: {
              events: function() {
                var e = h.get.event();
                e
                  ? (h.verbose("Attaching API events to element", e), T.on(e + k, h.event.trigger))
            ...
            create: {
              ...
              mockedXHR: function() {
                ...
                return (
                  ...
                  s
                    ? (e.isFunction(s)
                        ? (h.debug("Using specified synchronous callback", s), (n = s.call(E, f)))
                        : (h.debug("Using settings specified response", s), (n = s)),
              ...
              save: {
                ...
                direction: function() {
                  var e,
                    ...
                    n = v.get.lastScroll();
                  return (
                    (e = t > n && n ? "down" : n > t && n ? "up" : "static"), (v.cache.direction = e), v.cache.direction
                  );
                },
